...
/******/ 	var hotCurrentHash = "976040eb4658db76dbb7"; // eslint-disable-line no-unused-vars
...
/******/ 	__webpack_require__.p = "/example/bundle";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _logMapJs = __webpack_require__(2);

	var _logMapJs2 = _interopRequireDefault(_logMapJs);

	//启用日志文件
	__webpack_require__(3);
	__webpack_require__(6);
	$.logger.use(_logMapJs2['default']);
	//设置日志处理模块，可以分文件配置，也可以直接全局配置
	$.logger.executor = function (log) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreJs = __webpack_require__(4);

	var _coreJs2 = _interopRequireDefault(_coreJs);

	var _utilsCheckerJs = __webpack_require__(5);
	 ...
	 * 兼容所有事件类型,方法类型
	 */
	$.fn.logger._eventType = ['on', 'click', 'blur', 'focus', 'load', 'beforeunload', 'mouseover', 'mouseenter', 'change', 'input', 'keyup', 'scroll'];
	/**
	 * @param container jquery对象
	 */
	$.fn.logger.init = function (container) {
	  //初始化日志模块,修正所有的要处理的key
	  this._eventType.forEach(function (eventType) {
	    container[eventType] = _coreJs2['default'](eventType);
	  });
	};
	/**
	 * 初始化日志打点
	...
	$.fn.logger.use = function (logModule) {
	  ...
	  _utilsCheckerJs.checkLog(logModule);
	  //存放打点模块
...
/***/ function(module, exports) {
	...
	exports.__esModule = true;
	var logCore = function logCore(eventType) {
	    return function () {
	        //将方法重定向到jQuery的方法
	        var container = this;
	        //采用统一的jquery方式
	        if (eventType == 'on') {
	            $.fn.on.apply(container, logUtils.transArgs.apply(logUtils, arguments));
	        } else {
	            $.fn.on.apply(container, [eventType].concat(logUtils.transArgs.apply(logUtils, arguments)));
	        }
	    };
	};
	...
	var logUtils = {
	     ...
	     * 打点模块
	     */
	    triggerLogger: function triggerLogger() {
	        //获取打点参数
	        var $this = $(this);
	        var keyName = $this.data('logKey');
	        var dealKey = $.fn.logger.logModule[keyName];
	        var logArgs = {};
	        if (typeof dealKey == 'function') {
	            ...
	            logArgs = dealKey.apply.apply(dealKey, [this].concat(args));
...
/***/ function(module, exports) {
	...
	exports['default'] = {
	    //打印参数错误日志
	    _console: function _console(message) {
	     ...
	     */
	    checkLog: function checkLog(logger) {
	        var checkLogType = Object.prototype.toString;
	        if (!(typeof logger == 'object' && checkLogType.call(logger) == "[object Object]")) {
	            undefined._console('your logger should be a pure key/value object');
	            return false;
	        }
	    }
	};
